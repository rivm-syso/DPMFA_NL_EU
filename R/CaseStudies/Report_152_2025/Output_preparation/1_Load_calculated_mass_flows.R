...
if (modeltype == "dpmfa"){
  save(DPMFA_calculatedMassFlow, metadata,
       file = paste0(data_folder,"/DPMFA_calculated_mass_flows_", region, format(ModelRunDate,"%Y_%m_%d"),".RData"),
       compress = "xz",
       compression_level = 9)   
} else {
  save(DPMFA_calculatedMassFlow, metadata,
       file = paste0(data_folder,"/PMFA_calculated_mass_flows_", region, format(ModelRunDate,"%Y_%m_%d"),".RData"),
       compress = "xz",
       compression_level = 9)  
}
...
if (modeltype == "dpmfa"){
  save(DPMFA_years_of_interest, metadata,
       file = paste0(data_folder,"/DPMFA_calculated_mass_flows_years_of_interest_", region, format(ModelRunDate,"%Y_%m_%d"),".RData"),
       compress = "xz",
       compression_level = 9)   
} else {
  save(DPMFA_years_of_interest, metadata,
       file = paste0(data_folder,"/PMFA_calculated_mass_flows_years_of_interest_", region, format(ModelRunDate,"%Y_%m_%d"),".RData"),
       compress = "xz",
       compression_level = 9)  
}
