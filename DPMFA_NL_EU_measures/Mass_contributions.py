...
outputfoldername = "output_" + inputfile
...
for mat in materials:
    ...
    casestudy_output_folder = os.path.join(outputbasefolder, outputfoldername, mat)
    ...
    csvfolder = os.path.join(outputbasefolder, outputfoldername, mat, "csv")
    ...
    pickle_output_folder = os.path.join(outputbasefolder, outputfoldername, mat, 'Pickle_files')
