...
for mat in materials:
    ...
    in_use_discarded_to_comp = config.in_use_discarded_to_comps
    ...
    clothing_to_in_use_disc_combinations = list(itertools.product(clothing_to_comps, sink_comps))
    in_use_disc_to_sinks_combinations= list(itertools.product(in_use_discarded_to_comp, sink_comps))
