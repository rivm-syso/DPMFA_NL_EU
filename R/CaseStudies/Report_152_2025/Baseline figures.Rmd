...
# 
# load(paste0(data_folder, "/DPMFA_calculated_mass_flows_NL", data_name, ".RData"))
...
write.xlsx(table4, paste0("/rivm/r/E121554 LEON-T/03 - uitvoering WP3/DPMFA_textiel/Tables/Table4_", data_name, ".xlsx"))
```
...
write.xlsx(table, paste0("/rivm/r/E121554 LEON-T/03 - uitvoering WP3/DPMFA_textiel/Tables/Table_mass_and_percentages_to_sinks_", data_name, ".xlsx"))
```